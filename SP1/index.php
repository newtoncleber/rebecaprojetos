...
$query = "select * from users_projetos, projetos where projetos.id=users_projetos.id_projeto and users_projetos.id_user='{$user["id"]}' and projetos.id_localizacao=2";
